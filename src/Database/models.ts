...
const OrderSchema = new Schema(
	{
		...
		activatePrice: { type: Number, required: false },
		cumQuote: { type: Number, required: true },
		stopPrice: { type: Number, required: true },
		takeProfitBuy: { type: Number, required: true },
		takeProfitSell: { type: Number, required: true, default: 0 },
